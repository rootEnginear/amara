    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><h1>แนะนำภาษา</h1></div>
          <div class="panel-body">
            <p>&emsp;อมรา ไม่ได้ทำขึ้นเพื่อช่วยให้คนไทยสามารถเรียนรู้พื้นฐานการเขียนโปรแกรมได้เท่านั้น แต่ยังผัวฝรั่งได้ด้วย อิอิ เช่น justin, และอื่นๆ ได้อีกมากมาย</p>
          </div>
        </div>
