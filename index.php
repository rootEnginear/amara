    ...
    <div class="jumbotron">
      ...
      <div class="row">
        <div class="col-sm-10 col-md-offset-1" id="title_anim">
          <h1>"อมรา" <small>ภาษาเขียนโปรแกรมสำหรับคนไทย</small></h1>
        </div>
      </div>
      ...
      <div class="col-md-4 col-md-pull-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <p>&emsp;อมรา คือภาษาเขียนโปรแกรมที่ดัดแปลงมาจากภาษา Javascript เพื่อช่วยให้คนไทยสามารถเรียนรู้พื้นฐานการเขียนโปรแกรม และสามารถนำไปต่อยอดยังภาษาอื่นๆ ได้อีกต่อไป</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
